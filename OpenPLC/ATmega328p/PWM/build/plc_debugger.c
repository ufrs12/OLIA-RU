...
{&(RES0__INSTANCE0.DUTY_FB), WORD_O_ENUM},
{&(RES0__INSTANCE0.FREQ), WORD_O_ENUM},
{&(RES0__INSTANCE0.FREQ_REAL), REAL_ENUM},
{&(RES0__INSTANCE0.DUTY), WORD_O_ENUM},
...
{&(RES0__INSTANCE0._TMP_WORD_TO_REAL10_OUT), REAL_ENUM},
{&(RES0__INSTANCE0._TMP_WORD_TO_REAL11_OUT), REAL_ENUM}
};
