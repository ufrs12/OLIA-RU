...
void OLIA_EXAMLE_init__(OLIA_EXAMLE *data__, BOOL retain) {
  __INIT_LOCATED(INT,__QW0,data__->TESTVAR,retain)
  __INIT_LOCATED_VALUE(data__->TESTVAR,0)
  CTU_init__(&data__->CTU0,retain);
  TON_init__(&data__->TON0,retain);
  TP_init__(&data__->TP0,retain);
  __INIT_VAR(data__->_TMP_XOR20_OUT,__BOOL_LITERAL(FALSE),retain)
  R_TRIG_init__(&data__->R_TRIG1,retain);
}

// Code part
void OLIA_EXAMLE_body__(OLIA_EXAMLE *data__) {
  // Initialise TEMP variables

  __SET_VAR(data__->,_TMP_XOR20_OUT,,XOR__BOOL__BOOL(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (UINT)2,
    (BOOL)__GET_VAR(data__->TON0.Q,),
    (BOOL)__BOOL_LITERAL(TRUE)));
  __SET_VAR(data__->TP0.,IN,,__GET_VAR(data__->_TMP_XOR20_OUT,));
  __SET_VAR(data__->TP0.,PT,,__time_to_timespec(1, 1000, 0, 0, 0, 0));
  TP_body__(&data__->TP0);
  __SET_VAR(data__->TON0.,IN,,__GET_VAR(data__->TP0.Q,));
  ...
  __SET_LOCATED(data__->,TESTVAR,,__GET_VAR(data__->CTU0.CV,));
